...
public class Ciftlik2 implements Interface {
    ...
    public void calistir() {
        ...
        ciftlik.hayvanTipi.add("merinos");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(125);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("dorper");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(90);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("suffolk");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(80);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("herdwick");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(100);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("koyun");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(130);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("koyun");
        ciftlik.yas.add(2);
        ciftlik.kilo.add(120);
        i++;
        ciftlik.seriNumarasi.add(i);
        ciftlik.hayvanTipi.add("koyun");
        ciftlik.yas.add(4);
    ...
    public class Ciftlik extends CiftlikBank {
        ...
        static int koyunSutÜretimMiktari=4;
        final int koyunYemMaliyeti=1; //günlük
        ...
        public void ciflikBilgileriniYazdir() {
            ...
            gider = hayvansayisi*koyunYemMaliyeti;
            degeri = hayvansayisi*koyunDegeri;
        ...
        public int sütÜretimiGünlük(){
            ...
            return gelir= gelir+ koyunSayisi*koyunSutÜretimMiktari*4; // 1 hayvanın günlük ürettiği süt ile 100Tl kazanç sağlanıyor
        }
        public int koyunYemMaliyetiGünlük(){
            int koyunSayisi= seriNumarasi.size();
            // bir ineğin günlük yem maliyeti 23tldir.
            return this.gider = this.gider+ koyunSayisi*koyunYemMaliyeti;
        }
        public double koyunDegeri(){
            int koyunSayisi= seriNumarasi.size();
            // bir ineğin değeri 20.000Tldir

            return  (this.degeri =  koyunSayisi*700);
        }
